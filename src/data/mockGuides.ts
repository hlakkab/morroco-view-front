 ...
 * 
 * Pricing Model:
 * - priceHalfDay & priceFullDay are TOTAL TOUR PRICES (not per person)
 * - The price is DIVIDED by the number of tourists (1 to maxTouristsPerTour)
 * - Example: 600 MAD tour ÷ 3 people = 200 MAD per person
 * - This encourages group bookings and cost sharing
 */
