export default {
  ...
  guide: {
    guideList: 'Guides Locaux',
    searchGuides: 'Rechercher des guides...',
    filterGuides: 'Filtrer les Guides',
    noGuidesFound: 'Aucun guide trouvé pour les filtres sélectionnés',
    loadingGuides: 'Chargement des guides...',
    loading: 'Chargement...',
    failedToLoad: 'Échec du chargement des guides',
    ...
    tourPricing: 'Tarification des Tours',
    halfDayTour: 'Demi-Journée',
    fullDayTour: 'Journée Complète',
    perTour: 'par tour',
    perPerson: 'par personne',
    maxTourists: 'Max touristes par tour',
    people: 'personnes',
    reviews: 'avis',
    featured: 'En vedette',
    ...
    totalTourPrice: 'Prix Total du Tour',
    pricePerPerson: 'Prix Par Personne',
    totalPrice: 'Prix Total',
    shareTheCost: 'Partagez le coût avec votre groupe!',
    confirmReservation: 'Confirmer la Réservation',
    contact: 'Contact',
    call: 'Appeler',
    email: 'Email',
    whatsapp: 'WhatsApp',
    noInformation: 'Aucune information disponible pour ce guide.',
  },
  reservation: {
  ...
  copilot: {
    ...
    guide: {
      browseGuides: "Parcourez et sélectionnez un guide pour voir son profil et réserver des tours",
      searchGuide: "Recherchez des guides par nom, région ou spécialité",
      filterGuideByCity: "Sélectionnez une ville pour trouver des guides disponibles",
      viewGuideImages: "Consultez les images et les références du guide",
      seeGuideInfo: "Consultez la note, l'expérience et les tarifs du guide",
      viewLanguages: "Consultez les langues parlées par le guide",
      viewSpecialties: "Consultez les domaines d'expertise et les spécialités du guide",
      checkContactInfo: "Vérifiez les informations de contact et la disponibilité du guide",
      learnMore: "En savoir plus sur le parcours et l'expérience du guide",
      findLocation: "Trouvez l'emplacement d'activité du guide",
      bookGuide: "Réservez un tour avec ce guide"
    },
    tickets: {
