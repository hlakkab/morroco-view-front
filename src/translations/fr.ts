export default {
  ...
  reservation: {
    ...
    errorTitle: 'Réservation échouée',
    bookingFailed: 'Nous n\'avons pas pu finaliser votre réservation. Veuillez réessayer ou contacter le support.',
  ...
  entertainment: {
    ...
    filterType: 'Type de Divertissement',
    filterRating: 'Note Minimale',
    filterBooking: 'Exigence de Réservation',
  ...
  tours: {
    ...
    selectStartDateFirst: 'Veuillez d\'abord sélectionner une date de début',
    selectEndDateRequired: 'Veuillez sélectionner une date de fin',
    bothDatesSelected: 'Les deux dates sont sélectionnées - vous pouvez fermer la modal',
