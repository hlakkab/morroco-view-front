export default {
  ...
  copilot: {
    ...
    browseImages: "Parcourez les images d'artisans et sauvegardez-les dans vos favoris",
    viewArtisanInfo: "Consultez les informations importantes sur l'artisan",
    learnArtisanHistory: "En savoir plus sur le travail et l'histoire de l'artisan",
    ...
    selectTourDates: "Sélectionnez les dates de début et de fin de votre tour",
    ...
    browseMonuments: "Parcourez et sélectionnez des monuments pour voir les détails",
    ...
    viewEntertainmentImages: "Parcourez les images du lieu de divertissement et sauvegardez-les dans vos favoris",
    viewEntertainmentInfo: "Consultez les informations importantes sur le lieu de divertissement, y compris le type, les heures d'ouverture et l'emplacement",
    readEntertainmentDetails: "Lisez les informations détaillées sur le lieu",
    findEntertainmentLocation: "Trouvez l'emplacement du lieu et obtenez des directions",
    bookEntertainment: "Cliquez ici pour réserver",
    ...
    viewRestaurantImages: "Consultez les images du restaurant et sauvegardez-le dans vos favoris",
    ...
    moneyExchange: {
      ...
      airportOption: "Les bureaux de change de l'aéroport offrent de la commodité mais ont généralement les taux les plus bas",
      bankOption: "Les banques offrent plus de sécurité mais nécessitent plus de temps et ont parfois des horaires limités",
      brokerOption: "Les courtiers en change offrent les meilleurs taux avec des avantages supplémentaires"
    },
    esim: {
      buyESIM: "Achetez un eSIM pour rester connecté pendant votre voyage",
      selectOperator: "Choisissez votre opérateur préféré pour votre eSIM",
      selectOffer: "Sélectionnez le forfait qui correspond le mieux à vos besoins",
