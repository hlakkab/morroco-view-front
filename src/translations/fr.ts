export default {
  ...
  copilot: {
    ...
    browseImages: "Parcourez les images de l'événement et enregistrez vos événements favoris",
    ...
    seeBrokerType: "Consultez le type et le statut du bureau de change",
    viewServices: "Consultez les services proposés par ce bureau",
    checkContactInfo: "Vérifiez les coordonnées et les heures d'ouverture du bureau",
    learnMore: "En savoir plus sur ce bureau",
    findLocation: "Trouvez l'emplacement du bureau sur la carte",
    contactBroker: "Contactez directement le bureau",
    getVisitTips: "Obtenez des conseils utiles pour votre visite",
    findBrokers: "Tapez ici pour trouver des bureaux de change près de votre emplacement",
    ...
    searchBroker: "Recherchez un courtier par nom ou adresse",
    ...
    organizeActivities: "Organisez vos activités suivant l'ordre de votre choix",
    organizeNextButton: "Continuez à organiser votre circuit lorsque vous avez terminé",
    ...
    addTour: "Créez un nouveau circuit personnalisé en sélectionnant des lieux enregistrés et des événements",
