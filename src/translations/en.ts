export default {
  ...
  entertainment: {
    ...
    reviews: 'reviews',
    pricing: 'Pricing',
    filterType: 'Entertainment Type',
    filterRating: 'Minimum Rating',
    filterBooking: 'Booking Requirement',
    resetFilters: 'Reset',
  ...
  tours: {
    ...
    selectStartDateFirst: 'Please select a start date first',
    selectEndDateRequired: 'Please select an end date',
    bothDatesSelected: 'Both dates selected - you can close the modal',
