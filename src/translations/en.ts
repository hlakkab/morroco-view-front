export default {
  ...
  guide: {
    guideList: 'Local Guides',
    searchGuides: 'Search for guides...',
    filterGuides: 'Filter Guides',
    noGuidesFound: 'No guides found for the selected filters',
    loadingGuides: 'Loading guides...',
    loading: 'Loading...',
    failedToLoad: 'Failed to load guides',
    ...
    halfDayTour: 'Half Day',
    fullDayTour: 'Full Day',
    perTour: 'per tour',
    perPerson: 'per person',
    maxTourists: 'Max tourists per tour',
    people: 'people',
    reviews: 'reviews',
    featured: 'Featured',
    bookNow: 'Book Now',
    ...
    shareTheCost: 'Share the cost with your group!',
    confirmReservation: 'Confirm Reservation',
    contact: 'Contact',
    call: 'Call',
    email: 'Email',
    whatsapp: 'WhatsApp',
    noInformation: 'No information available for this guide.',
  },
  reservation: {
  ...
  copilot: {
    ...
    guide: {
      browseGuides: "Browse and select a guide to view their profile and book tours",
      searchGuide: "Search for guides by name, region, or specialty",
      filterGuideByCity: "Select a city to find available guides",
      viewGuideImages: "View the guide's images and credentials",
      seeGuideInfo: "See the guide's rating, experience, and pricing",
      viewLanguages: "View the languages spoken by the guide",
      viewSpecialties: "View the guide's areas of expertise and specialties",
      checkContactInfo: "Check the guide's contact information and availability",
      learnMore: "Learn more about the guide's background and experience",
      findLocation: "Find the guide's operating location",
      bookGuide: "Book a tour with this guide"
    },
    tickets: {
